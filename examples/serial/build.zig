...
pub fn build(b: *std.Build) void {
    ...
    serial_server_1.addIncludePath(LazyPath{ .cwd_relative = libmicrokit_include });
    serial_server_1.addIncludePath(sddf_dep.path("include"));
    serial_server_1.addObjectFile(LazyPath{ .cwd_relative = libmicrokit });
    serial_server_1.setLinkerScriptPath(LazyPath{ .cwd_relative = libmicrokit_linker_script });
    ...
    serial_server_2.addIncludePath(LazyPath{ .cwd_relative = libmicrokit_include });
    serial_server_2.addIncludePath(sddf_dep.path("include"));
    serial_server_2.addObjectFile(LazyPath{ .cwd_relative = libmicrokit });
    serial_server_2.setLinkerScriptPath(LazyPath{ .cwd_relative = libmicrokit_linker_script });
